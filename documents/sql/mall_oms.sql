...
CREATE TABLE `oms_order`  (
  ...
  `pay_type` int NULL DEFAULT NULL COMMENT '支付方式【101->paypal中国，102->paypal香港，103->paypal全球；201->支付宝，202->支付宝香港，203->支付宝全球；301->微信，302->微信香港，303->微信全球；401->银联；501->货到付款】\r\n',
...
CREATE TABLE `oms_order_return_apply`  (
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '申请状态【0->待处理，1->退货中，2->已完成，3->已拒绝】',
...
CREATE TABLE `oms_payment_info`  (
  ...
  `subject` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '交易内容',
