...
CREATE TABLE `sms_coupon`  (
  ...
  `coupon_type` tinyint NULL DEFAULT NULL COMMENT '优惠券类型【0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券】',
  `coupon_img` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '优惠券图片',
  `coupon_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '优惠券名字',
  ...
  `use_type` tinyint NULL DEFAULT NULL COMMENT '使用类型【0->全场通用；1->指定分类；2->指定商品】',
  ...
  `member_level` tinyint NULL DEFAULT NULL COMMENT '可以领取的会员等级【0->不限等级；其他->对应等级】',
  `publish` tinyint NULL DEFAULT NULL COMMENT '发布状态【0->未发布；1->已发布】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_coupon_history`  (
  ...
  `get_type` tinyint NULL DEFAULT NULL COMMENT '获取方式【0->后台赠送；1->主动领取】',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `use_type` tinyint NULL DEFAULT NULL COMMENT '使用状态【0->未使用；1->已使用；2->已过期】',
...
CREATE TABLE `sms_home_adv`  (
  ...
  `url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '广告详情链接地址',
...
CREATE TABLE `sms_home_subject`  (
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '显示状态',
  `url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '详情链接',
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  `img` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '专题图片地址',
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '首页专题表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sms_member_price`  (
  ...
  `add_other` tinyint NULL DEFAULT NULL COMMENT '可否叠加其他优惠【0->不可叠加优惠；1->可叠加】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_seckill_sku_notice`  (
  ...
  `notice_type` tinyint NULL DEFAULT NULL COMMENT '通知方式【0->短信；1->邮件】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  `seckill_price` decimal(18, 4) NULL DEFAULT NULL COMMENT '秒杀价格',
  `seckill_count` int NULL DEFAULT NULL COMMENT '秒杀总量',
  `seckill_limit` int NULL DEFAULT NULL COMMENT '每人限购数量',
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  `add_other` tinyint NULL DEFAULT NULL COMMENT '是否参与其他优惠',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  `add_other` tinyint NULL DEFAULT NULL COMMENT '是否叠加其他优惠【0->不可叠加；1->可叠加】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  `work` tinyint NULL DEFAULT NULL COMMENT '优惠生效情况【1111（四个状态位，从右到左）；0->无优惠，成长积分是否赠送；1->无优惠，购物积分是否赠送；2->有优惠，成长积分是否赠送；3->有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】】',
  PRIMARY KEY (`id`)
