...
CREATE TABLE `ums_integration_change_history`  (
  ...
  `source_type` tinyint NULL COMMENT '来源【0->购物；1->管理员修改；2->活动】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ums_member_collect_spu`  (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员收藏的商品' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ums_member_collect_subject`  (
  ...
  `subject_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '活动url',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ums_member_login_log`  (
  ...
  `login_type` tinyint NULL DEFAULT NULL COMMENT '登录类型【1->web；2->app】',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  `default_status` tinyint NULL DEFAULT NULL COMMENT '是否默认',
  PRIMARY KEY (`id`)
